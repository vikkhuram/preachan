 ...
 * MentionsItem.java
 *
 * Created on 30-Jul-2011, 15:14:36
 */
 ...
 * @author Kevin Doyle
 */
public class MentionsItem extends javax.swing.JPanel implements ListCellRenderer{

    /** Creates new form MentionsItem */
    public MentionsItem() {
        initComponents();
    }
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean sel, boolean focus) {
        ...
        String mentions=(st.getUser().getScreenName());

        jTextPane1.setText(mentions.toUpperCase()+": "+st.getText());
        return this;
}
